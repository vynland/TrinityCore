...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_CUS_QUESTCOMPLETER                     = 1000,
    RBAC_PERM_COMMAND_CUS_QUESTCOMPLETER_STATUS              = 1001,
    RBAC_PERM_COMMAND_CUS_QUESTCOMPLETER_ADD                 = 1002,
    RBAC_PERM_COMMAND_CUS_QUESTCOMPLETER_DEL                 = 1003,
    RBAC_PERM_COMMAND_CUS_QUESTCOMPLETER_RELOAD              = 1004,
    RBAC_PERM_COMMAND_CUS_QUESTCOMPLETER_COMMENT             = 1005,
    RBAC_PERM_COMMAND_CUS_QUESTCOMPLETER_DELCOMMENT          = 1006,
    RBAC_PERM_MAX
};
